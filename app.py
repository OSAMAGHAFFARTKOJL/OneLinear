    ...
    try:
        ...
        for chunk in ai71.AI71("api71-api-2fcb29da-a589-4632-9e26-47a71786cd25").chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                    "content": f"You are a helpful assistant for {option} problems. Dont give teh exact answer first and  provide meaningful responses only to highly valid queries and dont give resoponse to non-sensical or irrelevant inputs just say sorry it is irreelvant question"
                },
                {
                    "role": "user",
